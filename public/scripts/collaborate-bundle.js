...
Object(_functions__WEBPACK_IMPORTED_MODULE_0__["renderGroups"])().then(function (data) {//   console.log(data)
})["catch"](function (e) {
  console.log(e);
});
document.querySelector('#collaborate_create-group_btn').addEventListener('click', function (e) {
